  ...
  return (
    <div className="App">
      <header className="App-header">
        <h1>🖼️ Image Anti-Spoofing System</h1>
        <p>Upload an image to detect if it's REAL or FAKE (AI-generated/deepfake).</p>

        {/* Upload Form */}
        <form onSubmit={handleSubmit}>
          <input type="file" accept=".jpg,.jpeg,.png,.webp,.bmp" onChange={handleFileChange} />
